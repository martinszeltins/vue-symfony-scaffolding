...
import { transpileStyleSheet } from "./cssContainerQueriesPolyfillEngine";

function init() {
  // Do not enable the polyfill if the browser natively supports CSS Container Queries
  // Otherwise we'll use this polyfill until browser support lands.
  const supportsContainerQueries = "container" in document.documentElement.style;
  if (supportsContainerQueries) return false;
...
export { transpileStyleSheet, init };
